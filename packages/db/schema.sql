...
-- AI auto-reply settings (per-account, optional global)
...
-- Knowledge base articles for AI auto-reply context
...
-- FAQ extraction: cluster past messages_log into TOP-N candidate questions
